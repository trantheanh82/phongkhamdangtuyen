		...
		<table id="data" class="table table-bordered table-striped table-hover">
		    <thead>
			    <tr>
			      ...
			      <th class='text-center'><?=lang("IP")?></th>
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td class='text-center'><?=$v->email?></a>
						<td class='text-center'><?=$v->ip?></td>
						<td class='text-center'><?=$v->created_at?></td>
						<td class='text-center'><?=$v->updated_at?></td>
						<td class='text-center'><?=anchor('admin/services/delete/'.$v->id,'<i class="fa fa-trash"></i>',array('title'=>__('Delete',$this),'class'=>'confirm_delete'))?></td>
					</tr>
				<?php
						endforeach;
					endif;
