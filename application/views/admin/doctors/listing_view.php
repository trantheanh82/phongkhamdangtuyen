...
<?=content_open($page_name,$this)?>
	<div class='box-body'>
		<?php
			$this->load->view('admin/elements/ui/command_tools.php',array('command_tools'=>array('create'=>array('url'=>'admin/doctors/create','name'=>lang('Create Expert')))));
			?>
		<table id="data" class="table table-bordered table-striped table-hover">
		    <thead>
			    <tr>
			      ...
			      <th class='text-center'><?=lang("Experience")?></th>
			...
			<tbody>
              ...
              $edit_link = base_url()."admin/doctors/edit/".$v->id;
            ...
            <td><?=getSnippet($v->translation->content->experience,10)?> [<a href="<?=$edit_link ?>">...</a>]</td>
