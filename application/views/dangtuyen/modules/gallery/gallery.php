  ...
  <div class="row gallery-items-list">
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-1.jpg" alt="gallery-image" />
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-2.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-3.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-4.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-5.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-6.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-7.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
    ...
    <div class="col-md-6 col-lg-3 gallery-item">
      <div class="hover-overlay">
        ...
        <!-- Gallery Image -->
        <img class="img-fluid" src="<?=base_url().'assets/'.$template?>/images/gallery/image-8.jpg" alt="gallery-image" />
        <div class="item-overlay"></div>
