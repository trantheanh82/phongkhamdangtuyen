<!-- HEADER
			...
			<header id="header" class="header">
			    ...
			    <div class="wsmobileheader clearfix">
			    	...
			    	<span class="smllogo"><img src="<?=base_url().'assets/'.$template?>/images/logo.png" width="180" height="40" alt="mobile-logo"/></span>
			 	...
			 	<div class="headtoppart bg-blue clearfix">
			  	...
			  	<div class="wsmainfull menu clearfix">
    				<div class="wsmainwp clearfix">
    					...
    					<div class="desktoplogo"><a href="#hero-2"><img src="<?=base_url().'assets/'.$template?>/images/logo.png"  width="180" height="40" alt="header-logo"></a></div>
